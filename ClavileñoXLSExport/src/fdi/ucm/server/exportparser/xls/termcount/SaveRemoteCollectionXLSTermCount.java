 ...
 *
 */
public class SaveRemoteCollectionXLSTermCount extends SaveCollection {
	...
	public SaveRemoteCollectionXLSTermCount() {
		super();
	}
	...
	public CompleteLogAndUpdates processCollecccion(CompleteCollection Salvar,
		...
		try {
			FileO=CollectionXLSTermCount.processCompleteCollection(CL,Salvar,SoloEstructura,PathTemporalFiles);
		} catch (IOException e) {
			e.printStackTrace();
