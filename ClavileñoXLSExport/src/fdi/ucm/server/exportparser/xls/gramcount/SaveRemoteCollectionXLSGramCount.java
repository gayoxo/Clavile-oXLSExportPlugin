 ...
 *
 */
public class SaveRemoteCollectionXLSGramCount extends SaveCollection {
	...
	public SaveRemoteCollectionXLSGramCount() {
		super();
	}
	...
	public CompleteLogAndUpdates processCollecccion(CompleteCollection Salvar,
		...
		try {
			FileO=CollectionXLSGramCount.processCompleteCollection(CL,Salvar,SoloEstructura,PathTemporalFiles);
		} catch (IOException e) {
			e.printStackTrace();
